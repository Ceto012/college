                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7" style="display: flex; flex-direction: column;">
                                                    ...
                                                    <div class="toasted exito">
                                                        <div class="contenido">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="texto">Se ha completado la acción con éxito.
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="toasted error">
                                                        <div class="contenido">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="texto">Ha ocurrido un error al procesar la
                                                                    solicitud.</div>
                                                            </div>
                                                        </div>
                                                        <button class="btn-cerrar">X</button>
                                        ...
                                        <div style="flex: 1; display: flex; justify-content: center; align-items: center;">
                                            <img id="fullscreen-img" src="{{ asset('assets/img/auto.jpeg') }}" alt="Descripción de la imagen"
