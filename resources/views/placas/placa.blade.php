            ...
            <div class="card mb-4 mx-4 p-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        <div>
                            <a href="#" class="btn bg-secondary btn-sm mb-0" data-bs-toggle="modal" data-bs-target="#modalSubirCSV" style="color: white" type="button">+ Subir CSV</a>
                            <a href="" class="btn bg-primary btn-sm mb-0" data-bs-toggle="modal" data-bs-target="#modalRegistroPlaca" style="color: white" type="button">+ Registrar Placa</a>
                        </div>
                        <!-- Modal -->
                                    ...
                                    <form id="formSubirCSV" enctype="multipart/form-data">
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="file" id="archivoCSV" name="archivoCSV" accept=".csv" required>
                                            </div>
